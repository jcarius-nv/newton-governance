...
[CONTRIBUTORS.md](CONTRIBUTORS.md) lists the current Newton project maintainers and Technical Steering Committee (TSC) members. It is kept up to date via [scripts/sync_contributors.py](scripts/sync_contributors.py).
